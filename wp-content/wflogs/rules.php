...
$this->rules[721] = wfWAFRule::create($this, 721, NULL, 'rce', '100', 'WAF-RULE-721', 0, 'block', new wfWAFRuleComparisonGroup(new wfWAFRuleComparisonGroup(new wfWAFRuleComparison($this, 'md5Equals', '0704e8d7079f62e38a682c6a602ce1f7', array(wfWAFRuleComparisonSubject::create($this, array('request.md5Body', 'e75c691db2d3b29bdd498e38d3ad7306'), array (
)))), new wfWAFRuleLogicalOperator('OR'), new wfWAFRuleComparison($this, 'md5Equals', 'efa5761bc77a13e9cc33331d9d089d79', array(wfWAFRuleComparisonSubject::create($this, array('request.md5QueryString', '418c5509e2171d55b0aee5c2ea4442b5'), array (
))))), new wfWAFRuleLogicalOperator('AND'), new wfWAFRuleComparison($this, 'md5Equals', 'fe021943dcda87150f590b3475afaded', array(wfWAFRuleComparisonSubject::create($this, array('request.md5QueryString', '71860c77c6745379b0d44304d66b6a13'), array (
)),
wfWAFRuleComparisonSubject::create($this, array('request.md5Body', '71860c77c6745379b0d44304d66b6a13'), array (
)))), new wfWAFRuleLogicalOperator('AND'), new wfWAFRuleComparison($this, 'md5Equals', 'd961250d7e6b866c06ce0ef3381a26df', array(wfWAFRuleComparisonSubject::create($this, array('request.md5QueryString', '478f3a4c51824ad23cb50c1c60670c0f'), array (
)),
wfWAFRuleComparisonSubject::create($this, array('request.md5Body', '478f3a4c51824ad23cb50c1c60670c0f'), array (
)))), new wfWAFRuleLogicalOperator('AND'), new wfWAFRuleComparison($this, 'currentUserIsNot', 'administrator', array(wfWAFRuleComparisonSubject::create($this, 'server.empty', array (
))))));
