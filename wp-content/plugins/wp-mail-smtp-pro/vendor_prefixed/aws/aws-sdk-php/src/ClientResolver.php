...
class ClientResolver
{
    ...
    public static function _apply_credentials($value, array &$args)
    {
        ...
        if ($value instanceof \WPMailSMTP\Vendor\Aws\Credentials\CredentialsInterface) {
            ...
            $args['credentials'] = \WPMailSMTP\Vendor\Aws\Credentials\CredentialProvider::fromCredentials(new \WPMailSMTP\Vendor\Aws\Credentials\Credentials($value['key'], $value['secret'], $value['token'] ?? null, $value['expires'] ?? null));
        } elseif ($value === \false) {
